  ...
  const renderOverview = () => {
    return (
      <div className="flex flex-col h-full w-full bg-white">
        <div className="bg-white px-6 pt-8 pb-0 border-b border-slate-200 sticky top-0 z-20">
          <div className="flex justify-between items-center mb-6">
            <div className="flex flex-col gap-0.5">
              <h1 className="text-xl font-bold text-slate-900 font-outfit tracking-tight flex items-center gap-1.5">
                HQ OPS <div className="w-1.5 h-1.5 bg-slate-900 animate-pulse ml-0.5" />
              </h1>
              <p className="text-[9px] font-bold text-slate-400 font-noto uppercase tracking-[0.25em]">Executive Console</p>
            </div>
          ...
          <div className="flex">
             <button 
              ...
              className={cn(
                "flex-1 py-3 text-center text-[10px] font-bold font-outfit tracking-widest uppercase transition-all duration-200 border-b-2",
                activeTab === 'daily' ? "border-slate-900 text-slate-900" : "border-transparent text-slate-400 hover:text-slate-600"
              )}
            >
              Operations
            </button>
            <button 
              ...
              className={cn(
                "flex-1 py-3 text-center text-[10px] font-bold font-outfit tracking-widest uppercase transition-all duration-200 border-b-2",
                activeTab === 'monthly' ? "border-slate-900 text-slate-900" : "border-transparent text-slate-400 hover:text-slate-600"
              )}
            >
              Analytics
            </button>
