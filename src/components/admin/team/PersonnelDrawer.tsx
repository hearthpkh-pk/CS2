        ...
        <div className="flex-1 overflow-y-auto px-10 py-10 space-y-12 pb-40 custom-scrollbar">
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-2 gap-6 px-1">
              ...
              <div className="space-y-2 relative pt-2">
                <label className="absolute -top-1.5 left-3 px-1.5 bg-white text-[10px] font-bold text-slate-400 uppercase tracking-widest z-10 transition-colors">Temp Token</label>
                <input 
                  type="text" 
              ...
              <div className="grid grid-cols-2 gap-6">
                <div className="space-y-2 relative pt-2">
                  ...
                  <select 
                    ...
                    className="w-full bg-white border border-slate-200 rounded-2xl px-5 py-3.5 text-xs font-semibold text-slate-700 outline-none cursor-pointer focus:border-blue-500 transition-all"
                  >
