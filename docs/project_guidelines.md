...
- **ภาษาไทย**: ห้ามใช้ฟอนต์ที่มีหัว (Loopless / Sans-serif) โดยเด็ดขาด เช่น `Noto Sans Thai` หรือ `IBM Plex Sans Thai` (ห้ามใช้ฟอนต์ที่มีหัวเด็ดขาด หากพบเท่ากับประหาร)
- **ห้ามใช้สีม่วง (Purple)**: ห้ามมีสีม่วงปรากฏในระบบโดยเด็ดขาด ไม่ว่าจะเป็นส่วนประกอบใดๆ (ห้ามมีเด็ดขาด หากพบเท่ากับประหาร)
...
- **Dimensional Gradients**: การสร้างมิติแก่วงค์ประกอบต่างๆ (เช่น กราฟ หรือ Card) ให้ใช้การไล่เฉดของสีขาวหรือสีดำ (Shades & Tints) ผสมกับสีหลักเท่านั้น ห้ามใช้สีโทนอื่นมาผสมเด็ดขาด
